...
This is a typical example how we proceed to detect forks, initiations and terminations from the reads base_called with megalodon and our model then parsed with the Parsing_function4Megalodon.r script.  
...
The merged data file keep the same organization with a slightly simplified summary table. Those merged file are then used to produced the figures and data discussed in the manuscript.  
```{r}
