...
This is a typical example how we proceed to detect forks, initiaitons and terminations from the reads basecalled with megalodon and our model then parsed with our Parsing_function4Megalodon.r script.  
